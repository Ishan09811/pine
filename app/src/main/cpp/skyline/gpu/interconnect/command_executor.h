...
namespace skyline::gpu::interconnect {
    ...
    class CommandExecutor {
      private:
         ...
         */
        bool CreateRenderPassWithSubpass(vk::Rect2D renderArea, span<TextureView *> sampledImages, span<TextureView *> inputAttachments, span<TextureView *> colorAttachments, TextureView *depthStencilAttachment, bool noSubpassCreation = false, StageMask srcStageMask = {}, StageMask dstStageMask = {});
